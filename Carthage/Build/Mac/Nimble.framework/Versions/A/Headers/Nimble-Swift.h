...
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull to)(id <NMBMatcher> _Nonnull);
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull toWithDescription)(id <NMBMatcher> _Nonnull, NSString * _Nonnull);
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull toNot)(id <NMBMatcher> _Nonnull);
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull toNotWithDescription)(id <NMBMatcher> _Nonnull, NSString * _Nonnull);
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull notTo)(id <NMBMatcher> _Nonnull);
@property (nonatomic, readonly, copy) NMBExpectation * _Nonnull (^ _Nonnull notToWithDescription)(id <NMBMatcher> _Nonnull, NSString * _Nonnull);
...
SWIFT_CLASS("_TtC6Nimble14NMBObjCMatcher") SWIFT_DEPRECATED_MSG("Use NMBPredicate instead")
